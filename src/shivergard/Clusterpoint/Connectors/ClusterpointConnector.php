<?php namespace shivergard\Clusterpoint\Connectors;
...
class ClusterpointConnector extends Connector implements ConnectorInterface {
	...
	public function createConnection($tns, array $config, array $options)
	{
		...
		if ( ! in_array($config['driver'], ['clusterpoint']))
		{
